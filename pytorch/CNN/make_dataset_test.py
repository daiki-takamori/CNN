...
# 画像を格納しているディレクトリのパス
input_dir_nonclear = '/home/daiki/pytorch/box_marker/row/test'
input_dir_clear = '/home/daiki/pytorch/box_marker/removemarker/test'

# 画像を出力するディレクトリのパス
input_directory = '/home/daiki/pytorch/box_marker/resize/test'

# 重心店出力後のデータの出力先ディレクトリのパス
output_directory1 = '/home/daiki/pytorch/box_marker/marker_box/test'
output_directory2 = '/home/daiki/pytorch/box_marker/marker_cross/test'
...
def nonclear():
    ...
    # CSVファイルを最初に1回だけ作成
    csv_filename = os.path.join(output_directory3, 'test.csv') #訓練データ or テストデータでファイル名変更
    ...
    with open(output_directory3 +'/test.csv', 'w', newline='') as file:
